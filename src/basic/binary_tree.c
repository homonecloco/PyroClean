...
static TreeElement * tree_element_buffer_get_slot(TreeElementBuffer * teb);
 ...
 TreeElement *bt_find_min(TreeElement * te)
{
 ...
 TreeElement *bt_find_max(TreeElement * te)
{
 ...
 TreeElement *bt_find_sustitute(TreeElement * te)
{
	
	return NULL;
}

 TreeElement *binary_tree_get_root(BinaryTree * bt)
{
	return bt->root;
}
